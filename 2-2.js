...
const checkPassWordValidity = (letterPlacement, letter, password) => {
    const {first, second} = getLetterPLacement(letterPlacement);
...
const getLetterPLacement = (letterPlacement) => {
    const splitValues = letterPlacement.split("-");
    return {
        first: splitValues[0],
        second: splitValues[1]
    }
}
